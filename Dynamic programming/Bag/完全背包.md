...
### <font color = "green">0-1背包-滚动数组 -->完全背包</font>
...
### <font color = "green">组合VS排列</font>

#### <font color = "red">求组合数就是外层for循环遍历物品，内层for遍历背包</font>
...
#### <font color = "red">求**求排列数就是外层for遍历背包，内层for循环遍历物品**</font>
...
### <font color = "green">完全背包题型总结</font>
